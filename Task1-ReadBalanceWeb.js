...
//console.log(Web3)
//here this is commented out because require does not work on web, we will import directly on html file through directory instead
...
web3.eth.getBalance(address, (err, wei)=> { //this arrow function is from ECMA6 we can use normal function keyword here as well
    ...
    else{ console.log('wei balance', wei) //showing balances in wei of the address
        document.getElementById("main").innerHTML = `Balance in wei: ${wei}`
        let balance = web3.utils.fromWei(wei, "ether");
        console.log("balance in ethers", balance);
        document.getElementById("mains").innerHTML = `Balance in ethers: ${balance}`
